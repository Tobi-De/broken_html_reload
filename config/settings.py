...
APPS_DIR = BASE_DIR / "broken_html_reload"
...
LOCAL_APPS = [
    "broken_html_reload.core",
    "broken_html_reload.users",
]
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL", default="postgres:///broken_html_reload"
    )
}
...
ACCOUNT_FORMS = {"signup": "broken_html_reload.users.forms.UserSignupForm"}
